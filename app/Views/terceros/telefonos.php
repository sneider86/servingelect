...
<main>
    <div class="container-fluid">
        ...
        <?php } ?>
        <form method="post" action="<?php echo base_url(); ?>/terceros/agregar_Telefono_temporal" autocomplete="off">
                ...
                <div style="background: linear-gradient(90deg, #b2b8bc, #dbddde);" class="card-body">
                    <div class="form-group col-12">
                        <div class="row">
                            ...
                            <br />
                            <div class="col-12 col-sm-3">
                                <a style="height:2rem;" href="<?php echo base_url(); ?>/terceros/nuevo" class="btn btn-primary">Regresar</a>
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-sm table-striped" id="dataTable" width="100%" cellspacing="0">
                            ...
                            <tbody style="font-family:Arial;font-size:12px;">
                                ...
                                <td style="height:0.2rem;width:1rem;"><a href="<?php echo base_url() . '/terceros/editarTelefonos/';  ?>" title="Editar Registro"><input type="image" src="<?php echo base_url(); ?>/image/edit.png" width="16" height="16"></input></a></td>

                                <td style="height:0.2rem;width:1rem;"><a href="#" data-href="<?php echo base_url() . '/terceros/eliminarTelefonos/'; ?>" data-toggle="modal" data-target="#modal-confirma" data-placement="top" title="Eliminar Registro"><input type="image" src="<?php echo base_url(); ?>/image/trash.png" width="16" height="16"></input></a></td>
                                </tr>
                            </tbody>
                            </thead>
                        </table>
