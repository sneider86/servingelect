        ...
        <div class="container-fluid">
            ...
            <div>
                <p>
                    ...
                    <a style="height:2rem;width:6rem;" href="<?php echo base_url(); ?>/grupos/eliminados_grupos" class="btn btn-warning">Eliminados</a>
                </p>
            </div>
                ...
                <table class="table table-bordered table-sm table-striped" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tbody style="font-family:Arial;font-size:12px;">
                        <?php foreach ($datos as $dato) { ?>
                            ...
                            <td id="inp_edita" style="height:0.2rem;width:1rem;"><input href="#" data-toggle="modal" data-target="#modalEditar" onclick="seleccionaGrupo(<?php echo "'" . $dato['codigo'] . "'"; ?>);" type="image" src="<?php echo base_url(); ?>/image/edit.png" width="16" height="16" title="Editar Registro" <?php echo $editar; ?>></input></td>

                            <td style="height:0.2rem;width:1rem;"><input href="#" data-href="<?php echo base_url() . '/grupos/eliminar_grupo/' . $dato['codigo']; ?>" data-toggle="modal" data-target="#modal-confirma" type="image" src="<?php echo base_url(); ?>/image/trash.png" width="16" height="16" title="Eliminar Registro" <?php echo $eliminar; ?>></input></td>
                            </tr>
            ...
            <div class="modal-dialog modal-lg modal-dialog-scrollable" role="document">
                <div style="background: linear-gradient(90deg, #b4c1d9 , #b4c1d9);" class="modal-content">
                    ...
                    <div class="modal-footer">
                        <a href="<?php echo base_url(); ?>/grupos" style="height:2rem;width:6rem;" class="btn btn-primary">Regresar</a>
    ...
    <form method="POST" action="<?php echo base_url(); ?>/grupos/inserta_grupo" autocomplete="off">
        <div class="modal fade" id="modalNuevo" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg modal-dialog-scrollable" role="document">
                <div style="background: linear-gradient(90deg, #b4c1d9 , #b4c1d9);" class="modal-content">
                    <div class="modal-header">
                        <h5 style="color:#98040a;font-size:20px;font-weight:bold;" class="modal-title" id="exampleModalLabel">Agregar Grupos</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                        ...
                        <div class="form-group col-12">
                            <div class="row">
                                ...
                                <div class="col-md-5ths col-lg-5ths col-xs-6 col-sm-12">
                                    ...
                                    <input maxlength="4" class="form-control form-control-sm " onblur="buscarGrupo(this)" id="codigo" name="codigo" type="text" required></>
                                </div>
                                <div class="col-md-5ths col-lg-5ths col-xs-6 col-sm-12">
...
<script type="text/javascript">
    ...
    function buscarGrupo(id) {
        ...
        $.ajax({
            type: "PATH",
            url: "<?php echo base_url(); ?>/grupos/buscar_Grupo/" + document.getElementById('codigo').value,
            dataType: "json",
            success: function(r) {
                if (r) {
                    swal('', 'El Grupo Ingresado ya Existe. Verifique y Corrija.', '');
