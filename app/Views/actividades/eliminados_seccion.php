<div id="layoutSidenav_content">
    <main>
        <div class="container-fluid">
            ...
            <div>
                <p>
                    <a style="height:2rem" href="<?php echo base_url(); ?>/secciones" class="btn btn-warning">Regresar</a>
                </p>
            </div>
                    ...
                    <tbody>
                        <?php foreach ($datos as $dato) { ?>
                            <tr>
                                ...
                                <td style="height:0.2rem;width:1rem;"><input href="#" data-href="<?php echo base_url() . '/secciones/activa_seccion/' . $dato['codigo']; ?>" data-toggle="modal" data-target="#modal-confirma" data-placement="top" title="Activar Registro" type="image" src="<?php echo base_url(); ?>/image/recycleIII.png" width="16" height="16" <?php echo $activar; ?>></input></td>
                            </tr>
                        <?php } ?>
