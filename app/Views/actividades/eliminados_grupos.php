<div id="layoutSidenav_content">
    <main>
        <div class="container-fluid">
            ...
            <div>
                <p>
                <a style="height:2rem" href="<?php echo base_url(); ?>/grupos" class="btn btn-warning">Regresar</a>
                </p>
            </div>
                ...
                <table class="table table-bordered table-sm table-striped" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tbody style="font-family:Arial;font-size:12px;">
                        <?php foreach ($datos as $dato) { ?>
                            ...
                            <td style="height:0.2rem;width:1rem;"><input href="#" data-href="<?php echo base_url() . '/grupos/activar_grupo/' . $dato['codigo']; ?>" data-toggle="modal" data-target="#modal-confirma" data-placement="top" title="Activar Registro" type="image" src="<?php echo base_url(); ?>/image/recycleIII.png" width="16" height="16" <?php echo $activar; ?> ></input></td>
