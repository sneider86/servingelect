    ...
    <main>
        <div class="container-fluid">
            ...
            <div class="row col-md-5ths col-lg-5ths col-xs-6 col-sm-6">
                <p>
                    <a style="height:2rem;" href="<?php echo base_url(); ?>/proveedores/nuevo" class="btn btn-info">Agregar</a>
                    <a style="height:2rem;" href="<?php echo base_url(); ?>/proveedores/eliminados" class="btn btn-warning">Eliminados</a>
                </p>
                <div class="dropdown col-md-5ths col-lg-5ths col-xs-6 col-sm-6">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                        <a class="dropdown-item" href="<?php echo base_url(); ?>/proveedores/muestraProveedoresPdf">Catálogo de Proveedores(Pdf)</a>
                    </div>
                </div>
            </div>
        <br>
            ...
            <table class="table table-bordered table-sm table-striped" id="dataTable" width="100%" cellspacing="0">
                ...
                <tbody style="font-family:Arial;font-size:12px;">
                    <?php foreach ($datos as $dato) { ?>
                        ...
                        <td style="height:0.2rem;width:1rem;"><a href="<?php echo base_url() . '/proveedores/editar/' . $dato['id_p']; ?>" title="Editar Registro"><input type="image" src="<?php echo base_url(); ?>/image/edit.png" width="16" height="16"></input></a></td>
                        
                        <td style="height:0.2rem;width:1rem;"><a href="#" data-href="<?php echo base_url() . '/proveedores/eliminar/' . $dato['id_p']; ?>" data-toggle="modal" data-target="#modal-confirma" data-placement="top" title="Eliminar Registro"><input type="image" src="<?php echo base_url(); ?>/image/trash.png" width="16" height="16"></input></a></td>
                        </tr>
                    <?php } ?>
                </tbody>
            </table>
