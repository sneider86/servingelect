<div id="layoutSidenav_content">
    <main>
                        ...
                        <div style="background: linear-gradient(90deg, #b2b8bc, #b2b8bc);" class="card-body">
                            <div class="form-group ">
                                ...
                                <div class="col-md-5ths col-lg-5ths col-xs-6 col-sm-3">
                                        ...
                                        <input class="form-control form-control-sm" id="numero_documento" name="numero_documento" title="Ingresa Nro Documento y Presiona Enter" type="text" onblur="buscarRegistro('/proveedores/buscarProveedor/','Proveedor')"></>
                                    </div>
                                    <div class="col-md-5ths col-lg-5ths col-xs-6 col-sm-9">
                                        <label>Razón Social</label>
                                        <input class="form-control form-control-sm" onKeyUp="mayus(this);" id="razon_social" name="razon_social" type="text" onblur="buscarRegistro('/proveedores/buscarProveedor/','Proveedor')"></>
                                    </div>
                                </div>
                                <div class="row">
                                </div>
        ...
        <div>
            <form name="f2" method="POST" action="<?php echo base_url(); ?>/proveedores/insertar" autocomplete="off">
                <div class="card shadow-lg border-1 rounded-lg mt-1">
