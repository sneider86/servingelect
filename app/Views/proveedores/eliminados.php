...
<div id="layoutSidenav_content">
    <main>
        <div class="container-fluid">
            ...
            <div>
                <p>
                    <a style="height:2rem" href="<?php echo base_url(); ?>/clientes" class="btn btn-warning">Regresar</a>
                </p>
            </div>
            <br>
                    ...
                    <tbody style="font-family:Arial;font-size:12px;">
                        <?php foreach ($datos as $dato) { ?>
                            <tr>
                                ...
                                <td style="height:0.2rem;width:1rem;"><a href="#" data-href="<?php echo base_url() . '/clientes/activar/' . $dato['id']; ?>" data-toggle="modal" data-target="#modal-confirma" data-placement="top" title="Activar Registro"><input type="image" src="<?php echo base_url(); ?>/image/recycleIII.png" width="16" height="16"></input></a></td>
                            </tr>
                        <?php } ?>
