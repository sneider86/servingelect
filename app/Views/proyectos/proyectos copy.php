...
<div id="layoutSidenav_content">
    <main>
        <div class="container-fluid">
            ...
            <div>
                <p>
                    <a style="height:2rem;" href="<?php echo base_url(); ?>/proyectos/nuevo" class="btn btn-info" data-toggle="modal" data-target="#modalNuevaDotacion">Agregar</a>
...
<script>
    ...
    $(document).ready(function() {
        recargarGrupos('familia', 'grupo', '/proyectos/getGrupos/');
