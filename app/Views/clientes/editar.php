<div id="layoutSidenav_content">
    <main>
                            ...
                            <div class="form-group ">
                                <div class="row">
                                    <div class="col-md-5ths col-lg-5ths col-xs-6 col-sm-3">
                                        ...
                                        <input disabled class="form-control form-control-sm" id="numero_documento" name="numero_documento" title="Ingresa Nro Documento y Presiona Enter" type="text" value="<?php echo $datos['numero_documento'] ?>" onblur="buscarRegistro('/clientes/buscarCliente/','Cliente')"></>
                                    </div>
                                    <div class="col-md-5ths col-lg-5ths col-xs-6 col-sm-9">
                                        <label>Razón Social</label>
                                        <input disabled class="form-control form-control-sm" onKeyUp="mayus(this);" id="razon_social" name="razon_social" value="<?php echo $datos['razon_social'] ?>" type="text" onblur="buscarRegistro('/clientes/buscarCliente/','Cliente')"></>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="container p-1 my-1 border ">
            <form name="f2" method="POST" action="<?php echo base_url(); ?>/clientes/actualizar" autocomplete="off">
                <div class="card shadow-lg border-1 rounded-lg mt-1">
                    <input hidden="true" class="form-control " id="id" name="id" type="text" value="<?php echo $datos['id'] ?>"></>
                        ...
                        <div class="form-group col-12">
                            <div class="row">
                                <div class="col-md-5ths col-lg-5ths col-xs-6 col-sm-6">
                                    ...
                                    <div class="input-group">
                                        <input class="form-control form-control-sm" id="email_facturacion" name="email_facturacion" type="email" value="<?php echo $datos['email_facturacion'] ?>"></>
                                    </div>
                                </div>
                                <div class="col-md-5ths col-lg-5ths col-xs-6 col-sm-6">
                                    <label>Nombres del Contacto</label>
                                    <input class="form-control form-control-sm" onKeyUp="mayus(this);" id="nombre_contacto" name="nombre_contacto" type="text" value="<?php echo $datos['nombre_contacto'] ?>"></>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-5ths col-lg-5ths col-xs-6 col-sm-6">
                                    ...
                                    <input class="form-control form-control-sm" onKeyUp="mayus(this);" id="rep_legal" name="rep_legal" type="text" value="<?php echo $datos['rep_legal'] ?>"></>
                                </div>
                                <div class="col-md-5ths col-lg-5ths col-xs-6 col-sm-6">
                                    <label>Correo Representante Legal</label>
                                    <div class="input-group">
                                        <input class="form-control form-control-sm" id="email_replegal" name="email_replegal" type="email" value="<?php echo $datos['email_replegal'] ?>"></>
                                    </div>
                                </div>
                            </div>
                        </div>
