<div id="layoutSidenav_content">
    <main>
                        ...
                        <div style="background: linear-gradient(90deg, #b2b8bc, #b2b8bc);" class="card-body">
                            <div class="form-group ">
                                ...
                                <div class="col-md-5ths col-lg-5ths col-xs-6 col-sm-3">
                                        ...
                                        <input class="form-control form-control-sm" id="numero_documento" name="numero_documento" title="Ingresa Nro Documento y Presiona Enter" type="text" onblur="buscarRegistro('/personal/buscarPersonal/','Personal')"></>
                                    </div>
                                    <div class="col-md-5ths col-lg-5ths col-xs-6 col-sm-9">
                                        <label>Razón Social</label>
                                        <input class="form-control form-control-sm" onKeyUp="mayus(this);" id="razon_social" name="razon_social" type="text" onblur="buscarRegistro('/personal/buscarPersonal/','Personal')"></>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div>
            <form method="POST" name="f2" action="<?php echo base_url(); ?>/personal/insertar" autocomplete="off">
                <div class="card shadow-lg border-1 rounded-lg mt-1">
                        ...
                        <div class="form-group col-12">
                                ...
                                <div class="col-md-5ths col-lg-5ths col-xs-6 col-sm-2">
                                    ...
                                    <select class="form-control form-control-sm" id="tipo_sangre" name="tipo_sangre" type="text" required>
                                        ...
                                        <?php foreach ($tipo_sangre as $row) { ?>
                                            <option value="<?php echo $row['id']; ?>"><?php echo $row['resumen']; ?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-5ths col-lg-5ths col-xs-6 col-sm-3">
                                    ...
                                    <div class="input-group">
                                        <input class="form-control form-control-sm" id="numero_libreta" name="numero_libreta" type="text"></>
                            ...
                            <div class="row">
                                <div class="col-md-5ths col-lg-5ths col-xs-6 col-sm-3">
                                    ...
                                    <input class="form-control form-control-sm" id="cuenta_pago" name="cuenta_pago" type="text"></>
                                </div>
                                <div class="col-md-5ths col-lg-5ths col-xs-6 col-sm-3">
                                    ...
                                    <div class="input-group">
                                        <select class="form-control form-control-sm" id="banco_pago" name="banco_pago" type="text" required>
                                            ...
                                            <?php foreach ($bancos as $row) { ?>
                                                <option value="<?php echo $row['id_bco']; ?>"><?php echo $row['nombre']; ?></option>
                                            <?php } ?>
                                        </select>
                                        <span class="input-group-btn">
                                            <button title="Cargar Certificación Bancaria" href="" class="btn btn-success  form-control-sm" type="button" id="btn_cargarCertificado"><i class="fas fa-download" data-toggle="modal" data-target="#modalCargarArchivos"></i></button>
                                        </span>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-5ths col-lg-5ths col-xs-6 col-sm-3">
                                    ...
                                    <input class="form-control form-control-sm" id="nombres_contacto" name="nombres_contacto" type="text"></>
                                </div>
                                <div class="col-md-5ths col-lg-5ths col-xs-6 col-sm-3">
                                    <label>Dirección del Contacto</label>
                                    <input class="form-control form-control-sm" id="direccion_contacto" name="direccion_contacto" type="text"></>
                                </div>
                                <div class="col-md-5ths col-lg-5ths col-xs-6 col-sm-2">
                                    <label>Teléfono Fijo </label>
                                    <input class="form-control form-control-sm" id="fijo_contacto" name="fijo_contacto" type="text"></>
                                </div>
                                <div class="col-md-5ths col-lg-5ths col-xs-6 col-sm-2">
                                    <label>Teléfono Celular </label>
                                    <input class="form-control form-control-sm" id="movil_contacto" name="movil_contacto" type="text"></>
                                </div>
                                <div class="col-md-5ths col-lg-5ths col-xs-6 col-sm-2">
                            ...
                            <div class="row">
                                <div class="col-md-5ths col-lg-5ths col-xs-6 col-sm-3">
                                    <label>Cusrso Altura/F.Vencimiento </label>
