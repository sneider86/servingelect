                    ...
                    <tbody style="font-size:12px;">
                        <?php foreach ($datos as $dato) { ?>
                            <tr>
                                ...
                                <td style="height:0.2rem;width:1rem;"><a href="#" data-href="<?php echo base_url() . '/roles/activar/' . $dato['id']; ?>" data-toggle="modal" data-target="#modal-confirma" data-placement="top" title="Activar Registro"><i color="#059616" class="fas fa-trash-restore-alt"></i></a></td>
                            </tr>
                        <?php } ?>
